...
For monetary planning, the separate [team cost estimate](smart-office-team-cost-estimate.md) applies a **flat €800 per person-day to every role and seniority**. **Team labor is €348,800 baseline, or €418,560 with its 20% labor reserve.** The separately priced [Azure build allowance](smart-office-third-party-cost-estimate.md) is approximately **€876–€2,629** at the planning exchange rate. Combined figures appear only after those separate subtotals; unquoted vendor commitments are excluded.
...
The largest estimate risk is not ordinary CRUD work; it is the still-open production inputs that determine integration, security, capacity and recovery depth. Rebaseline after M3.3 when PoC evidence exists, then again after Q-01, Q-07–Q-09 and Q-11 are decided. See the separate [team cost estimate](smart-office-team-cost-estimate.md) for labor rates and the [third-party cost estimate](smart-office-third-party-cost-estimate.md) for cloud/vendor charges.
